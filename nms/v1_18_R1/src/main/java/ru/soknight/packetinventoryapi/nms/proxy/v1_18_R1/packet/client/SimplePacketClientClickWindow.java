package ru.soknight.packetinventoryapi.nms.proxy.v1_18_R1.packet.client;
...
public class SimplePacketClientClickWindow extends WrappedClientPacket implements PacketClientClickWindow {
    ...
    public int getModeID() {
        return handle.getEnumModifier(SimplePacketClientClickWindow.InventoryClickType.class, 4).read(0).ordinal();
    }
